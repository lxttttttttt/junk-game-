...
int main()
{
	unsigned char show[100][200] = { 0 };
	register short int a, b;
	register int *c1,*c2;
	int ic = 0, px[4] = { 0 }, py[4] = { 0 }, delx = 0, dely = 0,  startx, starty, t = 0, xc, yc,xq,yq,ep,en,c;
	char picmeun = 0, k = 0;
	...
	开发者调试 
	{
		h = 1;u = 1;j2 = 0;o2 = 0;j4 = 0;tian = 'b';mop[room] = 0;room = 71;comp = room;max = 5;x = 1638;
		...
		case 0:
		{
			...
			一直循环 //主显示器
			{
				...
				case 0:
				{
					...
					watcb(&show,creater,ep,en,ch1,ch2);
				...
				case 1:
				{
					watcb(&show[0][0], creater, xcar + 60, ycar + 16,ch1,ch2);
					/************
					*   准星    *
					*************/
					show[16][60] = '+';
